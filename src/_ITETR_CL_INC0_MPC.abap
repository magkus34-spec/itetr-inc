class /ITETR/CL_INC0_MPC definition
  public
...
TT_INVOICE type standard table of TS_INVOICE .
  ...
  types:
TT_LIFNRSH type standard table of TS_LIFNRSH .
  types:
  begin of TS_BUKRSSH,
     BUKRS type BUKRS,
     BUTXT type BUTXT,
  ...
  types:
TT_BUKRSSH type standard table of TS_BUKRSSH .
  types:
  begin of TS_DOWNLOADFILE,
     IV_BUKRS type BUKRS,
     IV_CONTENT_TYPE type /ITETR/INC_DE_CONTY,
     IV_DOCUMENT_UID type /ITETR/COM_E_DUICH,
     IV_DUICH type /ITETR/COM_E_DUICH,
     ...
     EV_DOC_BASE64 type string,
  end of TS_DOWNLOADFILE .
  types:
TT_DOWNLOADFILE type standard table of TS_DOWNLOADFILE .
  types:
  begin of TS_INVOICEDETAILONE,
     IV_DOCUI type /ITETR/COM_E_DUICH,
     ...
     MJAHR type MJAHR,
     SMBLN type MBLNR,
  end of TS_INVOICEDETAILONE .
  types:
TT_INVOICEDETAILONE type standard table of TS_INVOICEDETAILONE .
  types:
  begin of TS_INVOICEDETAILTWO,
     IV_DOCUI type /ITETR/COM_E_DUICH,
     DOCUI type /ITETR/COM_E_DUICH,
     MBLNR type MBLNR,
     MJAHR type MJAHR,
     ...
     EBELN type EBELN,
     EBELP type EBELP,
  end of TS_INVOICEDETAILTWO .
  types:
TT_INVOICEDETAILTWO type standard table of TS_INVOICEDETAILTWO .
  types:
  begin of TS_BSARTSH,
     BSART type ESART,
     BATXT type BATXT,
  ...
  types:
TT_BSARTSH type standard table of TS_BSARTSH .
  types:
  begin of TS_TAXIDSH,
     STCD2 type STCD2,
     NAME1 type NAME1_GP,
  ...
  types:
TT_TAXIDSH type standard table of TS_TAXIDSH .

  constants GC_BSARTSH type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'BSartSH' ##NO_TEXT.
  constants GC_BUKRSSH type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'BukrsSH' ##NO_TEXT.
  constants GC_DOWNLOADFILE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'DownloadFile' ##NO_TEXT.
  constants GC_INVOICE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Invoice' ##NO_TEXT.
  constants GC_INVOICEDETAILONE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'InvoiceDetailOne' ##NO_TEXT.
  constants GC_INVOICEDETAILTWO type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'InvoiceDetailTwo' ##NO_TEXT.
  constants GC_LIFNRSH type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'LifnrSH' ##NO_TEXT.
  constants GC_TAXIDSH type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'TaxIdSH' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_INVOICE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_LIFNRSH
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_BUKRSSH
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_DOWNLOADFILE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_INVOICEDETAILONE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_INVOICEDETAILTWO
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_BSARTSH
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_TAXIDSH
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS /ITETR/CL_INC0_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ITETR.INC0_SRV' ).

define_invoice( ).
define_lifnrsh( ).
define_bukrssh( ).
define_downloadfile( ).
define_invoicedetailone( ).
define_invoicedetailtwo( ).
define_bsartsh( ).
define_taxidsh( ).
  endmethod.


  method DEFINE_BSARTSH.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'BSartSH' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Batxt' iv_abap_fieldname = 'BATXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name  = '/ITETR/CL_INC0_MPC=>TS_BSARTSH' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'BSartSHSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'BukrsSH' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/ITETR/CL_INC0_MPC=>TS_BUKRSSH' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'BukrsSHSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'DownloadFile' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'IvBukrs' iv_abap_fieldname = 'IV_BUKRS' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'IvDuich' iv_abap_fieldname = 'IV_DUICH' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 36 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'EvDocBase64' iv_abap_fieldname = 'EV_DOC_BASE64' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = '/ITETR/CL_INC0_MPC=>TS_DOWNLOADFILE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'DownloadFileSet' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'IvField' iv_abap_fieldname = 'IV_FIELD' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 1 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SapBelnr' iv_abap_fieldname = 'SAP_BELNR' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'ALPHA' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SapGjahr' iv_abap_fieldname = 'SAP_GJAHR' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'GJAHR' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Xfield' iv_abap_fieldname = 'XFIELD' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Cusdn' iv_abap_fieldname = 'CUSDN' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Ddtyp' iv_abap_fieldname = 'DDTYP' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 1 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LoadDoc' iv_abap_fieldname = 'LOAD_DOC' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'ALPHA' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Ctype' iv_abap_fieldname = 'CTYPE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Sappr' iv_abap_fieldname = 'SAPPR' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 2 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Gappr' iv_abap_fieldname = 'GAPPR' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 1 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DifferenceType' iv_abap_fieldname = 'DIFFERENCE_TYPE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'WfStatus' iv_abap_fieldname = 'WF_STATUS' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'StaicColor' iv_abap_fieldname = 'STAIC_COLOR' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 1 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = '/ITETR/CL_INC0_MPC=>TS_INVOICE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'InvoiceSet' ). "#EC NOTEXT
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_INVOICEDETAILONE.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - InvoiceDetailOne
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'InvoiceDetailOne' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'IvDocui' iv_abap_fieldname = 'IV_DOCUI' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 36 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Sakto' iv_abap_fieldname = 'SAKTO' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'ALPHA' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Brtwr' iv_abap_fieldname = 'BRTWR' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
lo_property->set_maxlength( iv_max_length = 14 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Smbln' iv_abap_fieldname = 'SMBLN' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'ALPHA' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = '/ITETR/CL_INC0_MPC=>TS_INVOICEDETAILONE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'InvoiceDetailOneSet' ). "#EC NOTEXT
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_INVOICEDETAILTWO.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - InvoiceDetailTwo
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'InvoiceDetailTwo' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Zeile' iv_abap_fieldname = 'ZEILE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'StockQty' iv_abap_fieldname = 'STOCK_QTY' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ExcKdv' iv_abap_fieldname = 'EXC_KDV' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/ITETR/CL_INC0_MPC=>TS_INVOICEDETAILTWO' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'InvoiceDetailTwoSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'LifnrSH' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Ktokk' iv_abap_fieldname = 'KTOKK' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = '/ITETR/CL_INC0_MPC=>TS_LIFNRSH' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'LifnrSHSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'TaxIdSH' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/ITETR/CL_INC0_MPC=>TS_TAXIDSH' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'TaxIdSHSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20231123144022'.                  "#EC NOTEXT
